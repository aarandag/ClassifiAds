...
Cabe destacar que para la llevar a cabo la identificación entre agentes que haga posible la comunicación, se hace uso del AMS (servicio de páginas blancas). Los agentes que inician la comunicación consultarán al AMS la lista de agentes que hay
...
los aprovechamos al máximo. En la dirección \url{https://github.com/aarandag/ClassifiAds/tree/protocols}, la cual redirige al 
repositorio GitHub del presente proyecto, se puede ver una implementación parcial que hemos hecho de esta característica en el branch ``protocols''.
